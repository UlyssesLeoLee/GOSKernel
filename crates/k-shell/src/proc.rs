...
fn dispatch_text_command(
        ...
        || cmd == "graph core" || cmd == "core decomp" || cmd == "coreness"
    {
    ...
    } else if cmd == "graph topo117" || cmd == "gtopo117" || cmd == "neighborhood ennamonocontic" || cmd == "gnennamonoactc" || cmd == "neighborhood ennamonocontic edge" || cmd == "gnnhennamonoactc" || cmd == "neighborhood dohectyl sombor hh" || cmd == "gnnbhhso" || cmd == "gnennamonoactcnhennamonoactcnbhhso" {
        super::dispatch_graph_topo_indices117(sink);
    } else if cmd == "graph topo116" || cmd == "gtopo116" || cmd == "neighborhood ennacontic" || cmd == "gnennaactc" || cmd == "neighborhood ennacontic edge" || cmd == "gnnhennaactc" || cmd == "neighborhood dohectyl sombor gg" || cmd == "gnnbggso" || cmd == "gnennaactcnhennaactcnbggso" {
        super::dispatch_graph_topo_indices116(sink);
    } else if cmd == "graph topo115" || cmd == "gtopo115" || cmd == "neighborhood octaennacontic" || cmd == "gnnoctaennactc" || cmd == "neighborhood octaennacontic edge" || cmd == "gnnhoctaennactc" || cmd == "neighborhood dohectyl sombor ff" || cmd == "gnnbffso" || cmd == "gnnoctaennactcnhoctaennactcnbffso" {
        super::dispatch_graph_topo_indices115(sink);
    } else if cmd == "graph topo114" || cmd == "gtopo114" || cmd == "neighborhood octaoctocontic" || cmd == "gnnoctaoctactc" || cmd == "neighborhood octaoctocontic edge" || cmd == "gnnhoctaoctactc" || cmd == "neighborhood dohectyl sombor ee" || cmd == "gnnbeeso" || cmd == "gnnoctaoctactcnhoctaoctactcnbeeso" {
        super::dispatch_graph_topo_indices114(sink);
    } else if cmd == "graph topo113" || cmd == "gtopo113" || cmd == "neighborhood octaheptic" || cmd == "gnnoctaheptactc" || cmd == "neighborhood octaheptic edge" || cmd == "gnnhoctaheptactc" || cmd == "neighborhood dohectyl sombor dd" || cmd == "gnnbddso" || cmd == "gnnoctaheptactcnhoctaheptactcnbddso" {
        super::dispatch_graph_topo_indices113(sink);
    } else if cmd == "graph topo112" || cmd == "gtopo112" || cmd == "neighborhood octahexic" || cmd == "gnnoctahexactc" || cmd == "neighborhood octahexic edge" || cmd == "gnnhoctahexactc" || cmd == "neighborhood dohectyl sombor cc" || cmd == "gnnbccso" || cmd == "gnnoctahexactcnhoctahexactcnbccso" {
        super::dispatch_graph_topo_indices112(sink);
    } else if cmd == "graph topo111" || cmd == "gtopo111" || cmd == "neighborhood octapentic" || cmd == "gnnoctapentactc" || cmd == "neighborhood octapentic edge" || cmd == "gnnhoctapentactc" || cmd == "neighborhood dohectyl sombor bb" || cmd == "gnnbbso" || cmd == "gnnoctapentactcnhoctapentactcnbbso" {
        super::dispatch_graph_topo_indices111(sink);
    } else if cmd == "graph topo110" || cmd == "gtopo110" || cmd == "neighborhood octatetracontic" || cmd == "gnnoctatetraactc" || cmd == "neighborhood octatetracontic edge" || cmd == "gnnhoctatetraactc" || cmd == "neighborhood dohectyl sombor baa" || cmd == "gnnbaaso" || cmd == "gnnoctatetraactcnhoctatetraactcnbaaso" {
        super::dispatch_graph_topo_indices110(sink);
    } else if cmd == "graph topo109" || cmd == "gtopo109" || cmd == "neighborhood octatricontic" || cmd == "gnnoctatriactc" || cmd == "neighborhood octatricontic edge" || cmd == "gnnhoctatriactc" || cmd == "neighborhood dohectyl sombor bz" || cmd == "gnnbzso" || cmd == "gnnoctatriactcnhoctatriactcnbzso" {
        super::dispatch_graph_topo_indices109(sink);
    } else if cmd == "graph topo108" || cmd == "gtopo108" || cmd == "neighborhood octadicontic" || cmd == "gnoctadiactc" || cmd == "neighborhood octadicontic edge" || cmd == "gnnhoctadiactc" || cmd == "neighborhood dohectyl sombor by" || cmd == "gnnbyso" || cmd == "gnoctadiactcnhoctadiactcnbyso" {
        super::dispatch_graph_topo_indices108(sink);
    } else if cmd == "graph topo107" || cmd == "gtopo107" || cmd == "neighborhood octamonocontic" || cmd == "gnoctamonoactc" || cmd == "neighborhood octamonocontic edge" || cmd == "gnnhoctamonoactc" || cmd == "neighborhood dohectyl sombor bx" || cmd == "gnnbxso" || cmd == "gnoctamonoactcnhoctamonoactcnbxso" {
        super::dispatch_graph_topo_indices107(sink);
    } else if cmd == "graph topo106" || cmd == "gtopo106" || cmd == "neighborhood octacontic" || cmd == "gnoctaactc" || cmd == "neighborhood octacontic edge" || cmd == "gnnhoctaactc" || cmd == "neighborhood dohectyl sombor bw" || cmd == "gnnbwso" || cmd == "gnoctaactcnhoctaactcnbwso" {
        super::dispatch_graph_topo_indices106(sink);
    } else if cmd == "graph topo105" || cmd == "gtopo105" || cmd == "neighborhood heptaennacontic" || cmd == "gnheptaennactc" || cmd == "neighborhood heptaennacontic edge" || cmd == "gnnhheptaennactc" || cmd == "neighborhood dohectyl sombor bv" || cmd == "gnnbvso" || cmd == "gnheptaennactcnhheptaennactcnbvso" {
        super::dispatch_graph_topo_indices105(sink);
    } else if cmd == "graph topo104" || cmd == "gtopo104" || cmd == "neighborhood heptaoctacontic" || cmd == "gnheptaoctaactc" || cmd == "neighborhood heptaoctacontic edge" || cmd == "gnnhheptaoctaactc" || cmd == "neighborhood dohectyl sombor bu" || cmd == "gnnbuso" || cmd == "gnheptaoctaactcnhheptaoctaactcnbuso" {
        super::dispatch_graph_topo_indices104(sink);
    } else if cmd == "graph topo103" || cmd == "gtopo103" || cmd == "neighborhood heptaheptacontic" || cmd == "gnheptaheptaactc" || cmd == "neighborhood heptaheptacontic edge" || cmd == "gnnhheptaheptaactc" || cmd == "neighborhood dohectyl sombor bt" || cmd == "gnnbtso" || cmd == "gnheptaheptaactcnhheptaheptaactcnbtso" {
        super::dispatch_graph_topo_indices103(sink);
    } else if cmd == "graph topo102" || cmd == "gtopo102" || cmd == "neighborhood heptahexacontic" || cmd == "gnheptahexaactc" || cmd == "neighborhood heptahexacontic edge" || cmd == "gnnhheptahexaactc" || cmd == "neighborhood dohectyl sombor bs" || cmd == "gnnbsso" || cmd == "gnheptahexaactcnhheptahexaactcnbsso" {
        super::dispatch_graph_topo_indices102(sink);
    } else if cmd == "graph topo101" || cmd == "gtopo101" || cmd == "neighborhood heptapentacontic" || cmd == "gnheptapentactc" || cmd == "neighborhood heptapentacontic edge" || cmd == "gnnhheptapentactc" || cmd == "neighborhood dohectyl sombor br" || cmd == "gnnbrso" || cmd == "gnheptapentactcnhheptapentactcnbrso" {
        super::dispatch_graph_topo_indices101(sink);
    } else if cmd == "graph topo100" || cmd == "gtopo100" || cmd == "neighborhood heptatetracontic" || cmd == "gnheptatetraactc" || cmd == "neighborhood heptatetracontic edge" || cmd == "gnnhheptatetraactc" || cmd == "neighborhood dohectyl sombor bq" || cmd == "gnnbqso" || cmd == "gnheptatetraactcnhheptatetraactcnbqso" {
        super::dispatch_graph_topo_indices100(sink);
    } else if cmd == "graph topo99" || cmd == "gtopo99" || cmd == "neighborhood heptatricontic" || cmd == "gnheptatriactc" || cmd == "neighborhood heptatricontic edge" || cmd == "gnnhheptatriactc" || cmd == "neighborhood dohectyl sombor bp" || cmd == "gnnbpso" || cmd == "gnheptatriactcnhheptatriactcnbpso" {
        super::dispatch_graph_topo_indices99(sink);
    } else if cmd == "graph topo98" || cmd == "gtopo98" || cmd == "neighborhood heptadicontic" || cmd == "gnheptadiactc" || cmd == "neighborhood heptadicontic edge" || cmd == "gnnhheptadiactc" || cmd == "neighborhood dohectyl sombor bo" || cmd == "gnnboso" || cmd == "gnheptadiactcnhheptadiactcnboso" {
        super::dispatch_graph_topo_indices98(sink);
    } else if cmd == "graph topo97" || cmd == "gtopo97" || cmd == "neighborhood heptaencontic" || cmd == "gnheptaenactc" || cmd == "neighborhood heptacontic edge" || cmd == "gnnhheptaenactc" || cmd == "neighborhood dohectyl sombor bn" || cmd == "gnnbnso" || cmd == "gnheptaenactcnhheptaenactcnbnso" {
        super::dispatch_graph_topo_indices97(sink);
    } else if cmd == "graph topo96" || cmd == "gtopo96" || cmd == "neighborhood heptacontic" || cmd == "gnheptaactc" || cmd == "neighborhood heptacontic edge" || cmd == "gnnhheptaactc" || cmd == "neighborhood dohectyl sombor bm" || cmd == "gnnbmso" || cmd == "gnheptaactcnhheptaactcnbmso" {
        super::dispatch_graph_topo_indices96(sink);
        ...
        super::dispatch_graph_topo_indices93(sink);
    } else if cmd == "graph topo92" || cmd == "gtopo92" || cmd == "neighborhood hexahexactic" || cmd == "gnhexahexaactc" || cmd == "neighborhood hexapentactic edge" || cmd == "gnnhhexahexaactc" || cmd == "neighborhood dohectyl sombor bi" || cmd == "gnnbisos" || cmd == "gnhexahexaactcnhhexahexaactcnbisos" {
        super::dispatch_graph_topo_indices92(sink);
    } else if cmd == "graph topo91" || cmd == "gtopo91" || cmd == "neighborhood hexapentactic" || cmd == "gnhexapentactc" || cmd == "neighborhood hexatetractic edge" || cmd == "gnnhhexapentactc" || cmd == "neighborhood dohectyl sombor bh" || cmd == "gnnbhso" || cmd == "gnhexapentactcnhhexapentactcnbhso" {
        super::dispatch_graph_topo_indices91(sink);
        ...
        super::dispatch_graph_topo_indices86(sink);
    } else if cmd == "graph topo85" || cmd == "gtopo85" || cmd == "neighborhood nonapentacontic" || cmd == "gnnonapentaactc" || cmd == "neighborhood octapentacontic edge" || cmd == "gnnhnonapentaactc" || cmd == "neighborhood dohectyl sombor bb" || cmd == "gnnbbso" || cmd == "gnnonapentaactcnhnonapentaactcnbbso" {
        super::dispatch_graph_topo_indices85(sink);
    } else if cmd == "graph topo84" || cmd == "gtopo84" || cmd == "neighborhood octopentacontic" || cmd == "gnoctopentaactc" || cmd == "neighborhood heptapentacontic edge" || cmd == "gnnhoctopentaactc" || cmd == "neighborhood tetrahectyl sombor" || cmd == "gnnbaso" || cmd == "gnoctopentaactcnhoctopentaactcnbaso" {
        super::dispatch_graph_topo_indices84(sink);
    } else if cmd == "graph topo83" || cmd == "gtopo83" || cmd == "neighborhood heptapentacontic" || cmd == "gnheptpentaactc" || cmd == "neighborhood hexapentacontic edge" || cmd == "gnnhheptpentaactc" || cmd == "neighborhood dohectyl sombor" || cmd == "gnnazso" || cmd == "gnheptpentaactcnhheptpentaactcnazso" {
        super::dispatch_graph_topo_indices83(sink);
