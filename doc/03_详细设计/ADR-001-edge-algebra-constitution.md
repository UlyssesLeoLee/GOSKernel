...
| 版本 | 日期 | 变更内容 | 作成者 |
|---|---|---|---|
| v1.0 | 2026-06-08 | 提案初版；property test 落地并全绿 | GOS 核心团队 |
| v1.1 | 2026-07-01 | 纳入日系工程阶段目录（03_详细设计）；补充文档管理信息，状态仍为待批准，未擅自升级 | GOS 核心团队 |
...
当前 runtime 暴露 9 条语义边：`Depend / Call / Spawn / Signal / Return / Mount / Sync / Stream / Use`（见 [GOS_ARCH_v2.md §3.2](../02_基本设计/GOS_ARCH_v2.md)）。
...
2. **禁止把语义藏进 node 私有状态**。跨 node 协作必须通过边表达（延续 [GOVERNANCE §2.3](../00_项目管理/GOS_GOVERNANCE_v0_2.md)）。
