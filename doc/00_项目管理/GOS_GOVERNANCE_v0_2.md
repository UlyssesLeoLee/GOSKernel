...
| 版本 | 日期 | 变更内容 | 作成者 |
|---|---|---|---|
| v1.0 | 2026-06-30 | 纳入日系工程阶段目录（00_项目管理），确立治理口径 v0.2 | GOS 核心团队 |
| v1.1 | 2026-07-01 | 补充文档管理信息；与 [RULE_GRAPH_PRIME.md](./RULE_GRAPH_PRIME.md)、[GOS_ARCH_v2.md](../02_基本设计/GOS_ARCH_v2.md) 交叉校验，术语口径一致 | GOS 核心团队 |
